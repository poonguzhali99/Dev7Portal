...
import Newadmissionview from './Newadmissionview';
import './style.scss';
...
const Newadmissionsetup = () => {
	...
	return (
		<div className="container-fluid container-xl dashboard">
			<Card >	<h4 >&nbsp;New Admission Setup </h4></Card>
			<div>
				...
				<div>
                    ...
                    // <p>coming</p>
                   <Card className="mt-3"> <Newadmissionview data={messages} data22={startindex} data33={endindex}  /></Card>
...
export default Newadmissionsetup;

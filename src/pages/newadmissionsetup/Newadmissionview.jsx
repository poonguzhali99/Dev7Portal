...
const Newadmissionview = (props) => {
    ...
    const columns = [
     ...
     
        {
          ...
          {
            dataField: "SecondLanguage",
            text: "2nd Lang",
            align: 'center',
            headerAlign: 'center'
          },
          {
            dataField: "ThirdLanguage",
            text: "3rd Lang",
            align: 'center',
            headerAlign: 'center'
          },
          {
            dataField: "AdmissionOpenDate",
            text: "Admissions Start Date",
            align: 'center',
            headerAlign: 'center'
          },
          {
            dataField: "AdmissionsCloseDate",
            text: "Admissions End Date",
            align: 'center',
            headerAlign: 'center'
          },
          ...
          {
            dataField: "ApplicationsAvailable",
...
export default Newadmissionview;
...
import Newadmissioncountview from './Newadmissioncountview';
import './style.scss';
...
const Newadmissioncount = () => {
	...
	const {
        ...
        const [ stuProcessName1, setstuProcessName ] = useState([ '' ]);
	...
	return (
		<div className="container-fluid container-xl dashboard">
			<Card >	<h4 >&nbsp;New Admission Count </h4></Card>
			<div>
				{academicYear.length > 0 &&(<Card style={{ padding: "18px" }}>
					...
					<Formik
						initialValues={{
							...
							Branch: userDetails.Userbranch,
							AssesmentClass: null,
                            Stages:stuProcessName1
                            
						
						}}
						onSubmit={(values) => {
                            if(stuProcessName1[0]==['']){
                                swal.fire({
                                    text: 'Please select the stage',
				...
				<div>
                    ...
                    // <p>coming</p>
                   <Card className="mt-3"> <Newadmissioncountview data={messages} data22={startindex} data33={endindex}  /></Card>
...
export default Newadmissioncount;
